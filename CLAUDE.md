...
| 우선순위 | 관심 영역 |
|---------|----------|
| 🔴 핵심 | 구매·조달 AI 도구, 공급망 자동화, 원자재 시장 AI 분석 |
| 🟡 관련 | 산업·제조 AI, B2B ERP/계약관리, 무역·관세 정책 |
| ⚪ 참고 | 일반 LLM 모델 출시, 범용 AI 동향 |

브리핑 생성 시 위 우선순위 순으로 뉴스를 정렬하고, 각 뉴스에 연관성 배지와 이유를 표시한다.
구매 담당자 Action Point 섹션을 매 브리핑에 필수 포함한다.
